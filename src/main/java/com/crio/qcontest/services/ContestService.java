...
public class ContestService{
    ...
    public Contestant createContestant(Long contestId, String userName) {
        User creator = userRepository.findByName(userName).orElseThrow(() -> new RuntimeException("User name: "+ userName +" not found!"));
        Contest contest = contestRepository.findById(contestId).orElseThrow(() -> new RuntimeException("Contest Id: " + contestId + " not found!"));
        // Contestant contestant = contestantRepository.find(contestId, userName).get();
        ...
        Contest oContest = contestRepository.findById(contestId).get();
        Contestant nContestant = new Contestant(user, oContest);
        return contestantRepository.save(nContestant);
    }
